...
On Linux the directory generally is already present on `PATH` (you may
need to log out and back in if the Rapp installer created the directory).
Use the `destdir` argument if you prefer an alternate location.
